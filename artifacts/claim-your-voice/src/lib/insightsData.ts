...
export const insightArticles: InsightArticle[] = [
  {
    ...
    summary: "If you have a personal journey but feel stuck, you are not alone. The first thing you need is clarity, not a personal action plan.",
    audienceTag: "Idea stage",
    shortAnswer: "If you have a personal journey but feel stuck, you are not alone. Most people think the next step is writing a personal action plan. It is not. The first thing you need is clarity.",
    sections: [
      {
        heading: "Get clear on the problem before thinking about the solution",
        content: [
          "Many new members spend too much time thinking about what they want to build. Strong businesses start the other way around.",
          "Ask yourself:"
        ],
        list: [
    ...
    howWeHelp: "We help members move from idea confusion to structured execution without overbuilding or wasting time."
  },
  {
    slug: "journey-roadmap-without-overthinking",
    title: "How First-Time Members Can Build a Clear Journey Roadmap Without Overthinking",
    summary: "A journey roadmap is not a detailed plan that tries to predict the future. It is a simple guide that helps you decide what to focus on right now.",
    audienceTag: "First-time member",
    shortAnswer: "A journey roadmap is not a detailed plan that tries to predict the future. It is a simple guide that helps you decide what to focus on right now and what can wait.",
    sections: [
      {
      ...
      {
        heading: "The three layers of a member's roadmap",
        content: [
      ...
      {
        heading: "Common mistakes first-time members make",
        content: [
          "Many new members overcomplicate their roadmap without realizing it.",
          "Common mistakes include:",
          "Simple decisions made early beat perfect plans made late."
        ],
        list: [
          "Copying processes from big companies that do not fit an early journey",
    ...
    howWeHelp: "We help first-time members translate ambition into focused execution."
  },
  {
    slug: "experienced-guidance-for-members",
    title: "What Experienced Guidance Really Means for Early-Stage Members",
    ...
    sections: [
      {
        heading: "Why members often struggle on their own",
        content: [
          "Early-stage members are constantly making decisions, often without enough context.",
      ...
      },
      {
        ...
        content: [
          ...
          "For early-stage members, the most valuable guidance usually comes from people who have built and scaled businesses themselves."
        ]
      }
    ],
    practicalSteps: [
  ...
  {
    slug: "prepare-journey-for-launch",
    title: "How to Prepare Your Journey for Launch Without Wasting Time or Money",
    ...
    audienceTag: "Early-stage journey",
    ...
    howWeHelp: "We help journeys launch with confidence and operational discipline."
  },
  {
    slug: "when-to-scale-journey",
    title: "When Is the Right Time to Start Scaling an Early-Stage Journey?",
    summary: "Scaling too early is one of the fastest ways to break a young journey. Growth only works when you can deliver value consistently.",
    audienceTag: "Early-stage journey",
    shortAnswer: "Scaling too early is one of the fastest ways to break a young journey. Growth only works when you can deliver value in a consistent and predictable way.",
    sections: [
      {
        heading: "Signs you are not ready to scale yet",
        content: [
          "Many members think they are ready to grow when they are actually just busy.",
    ...
    howWeHelp: "We help members scale responsibly without breaking what works."
  }
];
