 ...
 * - Guide payouts = Cost of services (COGS), NOT revenue reduction
 * 
 * VIEW PRINCIPLES:
 * - Member view = truth (full transparency for decision making)
...
/**
 * Default values for internal mode (member view)
 */
 ...
 * NOTE: This is 100% platform revenue. The 80% paid to specialists is NOT revenue.
 */
...
/**
 * Calculate guide expense from subscriptions
 * Formula: subscriptionRevenue * (mentorPayoutRate / 100)
 * Guides receive 50% of subscription revenue as compensation
 */
...
/**
 * Calculate guide expense from coaching commission
 * Formula: coachingCommissionRevenue * (mentorCoachingPayoutRate / 100)
 * Guides receive 0-50% of coaching commission (platform's 20% cut) as compensation
 */
...
/**
 * Calculate total guide expenses (COGS)
