...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    { href: "/insights", label: "Journey Radar", testId: "nav-insights" },
    { href: "/member-focus", label: "Focus Score", testId: "nav-member-focus" },
    ...
    <div className="min-h-screen flex flex-col font-sans bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/80 backdrop-blur-md supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-24 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <Link href="/member-focus" data-testid="link-get-started">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-white/10 bg-background/95 backdrop-blur-md">
            <div className="container mx-auto px-4 py-4 space-y-3">
              ...
              <Link href="/member-focus" data-testid="link-mobile-get-started">
      ...
      <footer className="border-t border-border bg-muted/30 py-12" data-testid="footer">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <br/>
              AI helps you understand your journey.
              <br/>
              <span className="font-bold">People help you move forward.</span>
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/insights" data-testid="link-footer-insights">Journey Radar</Link></li>
              <li><Link href="/member-focus" data-testid="link-footer-member-focus">Focus Score</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/member-focus" data-testid="link-footer-member">Member: Submit your Idea</Link></li>
              <li><Link href="/become-guide" data-testid="link-footer-guide">Become a Guide</Link></li>
              <li><Link href="/become-specialist" data-testid="link-footer-specialist">Become a Specialist</Link></li>
              <li><Link href="/supporters" data-testid="link-footer-supporters">For Supporters</Link></li>
            </ul>
          </div>
        ...
        <div className="container mx-auto px-4 mt-12 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} ClaimYourVoice.org. All rights reserved.
          <br />
          <span className="text-xs">ClaimYourVoice is dedicated to supporting those affected by Selective Mutism.</span>
        </div>
      </footer>
    </div>
  );
