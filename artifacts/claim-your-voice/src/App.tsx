  ...
  return (
    <Layout>
      <Switch>
        ...
        <Route path="/guides" component={MentorDirectory} />
        <Route path="/pricing" component={Pricing} />
        <Route path="/qa" component={QA} />
        <Route path="/how-it-works" component={HowItWorks} />
        <Route path="/become-member" component={BecomeaEntrepreneur} />
        <Route path="/become-guide" component={MentorWaitlist} />
        <Route path="/become-mentor2" component={BecomeaMentor} />
        <Route path="/become-specialist" component={BecomeaCoach} />
        <Route path="/supporters" component={BecomeaInvestor} />
        ...
        <Route path="/dashboard-member" component={DashboardEntrepreneur} />
        <Route path="/dashboard-specialist" component={DashboardCoach} />
        <Route path="/dashboard-guide" component={DashboardMentor} />
        <Route path="/dashboard-supporter" component={DashboardInvestor} />
        <Route path="/admin-guide-approval" component={AdminMentorApproval} />
        ...
        <Route path="/rate-specialist" component={RateCoach} />
        <Route path="/contact-specialist/:coachId" component={ContactCoach} />
        <Route path="/specialist/:coachId" component={CoachProfile} />
        ...
        <Route path="/member-focus" component={FounderFocusScore} />
