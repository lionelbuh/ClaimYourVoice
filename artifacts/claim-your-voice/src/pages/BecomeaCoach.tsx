...
const EXPERTISE_OPTIONS = [
  "Selective Mutism Treatment (CBT/iCBT)",
  "Graduated Exposure Therapy",
  "Speech-Language Pathology",
  "Child & Adolescent Psychology",
  "School-Based SM Support",
  ...
  "Neurodiversity & SM",
  "Online & Telehealth SM Therapy",
  "SMIRA / iCBT Methodology",
  "Early Childhood Intervention",
  "Research & Assessment"
];

const FOCUS_AREAS_OPTIONS = [
  "Children with SM (ages 3-12)",
  "Teenagers with SM (ages 13-18)",
  "Adults with SM",
  "Parents & Caregivers",
...
export default function BecomeaCoach() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Specialist form submitted, validating...", formData);
    ...
    if (!contractAgreed) {
      alert("Please read and agree to the Specialist Platform Agreement to submit your application");
      return;
    }
    ...
    try {
      ...
      console.log("Submitting to:", `${API_BASE_URL}/api/specialists`);
      ...
      console.error("Specialist submission error:", error);
        ...
        <DialogContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-4 py-6">
            ...
            <p className="text-center text-base text-slate-600 dark:text-slate-400">
              Our team will review your application and get back to you within <strong>24-48 hours</strong>. We look forward to having you join the ClaimYourVoice coaching team!
            </p>
          </div>
          <Button
            ...
            data-testid="button-thank-you-ok-specialist"
          >
            I Understand
          </Button>
        </DialogContent>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-bold mb-6 text-slate-900 dark:text-white">
              Become a Specialist on ClaimYourVoice
            </h1>
            <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
              Share your SM expertise. Help people make real progress. Earn while making a meaningful difference.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <Card className="mb-12 -mt-8 border-cyan-200 dark:border-cyan-900/30 bg-cyan-50 dark:bg-cyan-950/20">
            <CardContent className="p-10">
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                ClaimYourVoice is building a network of SM Specialists — licensed clinicians, speech-language pathologists, psychologists, educators, and SM experts — who offer specialized sessions and resources to members who need clinical or professional-level support. SM Guides support members through their journey, while Specialists provide the expert intervention that creates real breakthroughs.
              </p>
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed mt-2">
                As a Specialist, you bring your clinical or professional expertise directly to the SM community — on your terms.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
              We invite SM Specialists with professional backgrounds and credentials in fields such as:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                "Speech-language pathology with SM or selective mutism experience",
                "Child psychology, clinical psychology, or anxiety treatment (CBT/iCBT)",
                "Educational psychology, school counseling, or SENCO expertise",
                "Social work, family therapy, or play therapy",
                "Any clinical or advocacy background that helps SM members make progress"
              ].map((item, i) => (
            ...
            <Card className="mt-8 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
              <CardContent className="p-6">
                <p className="text-slate-700 dark:text-slate-300 text-lg">
                  <span className="font-semibold">If you've worked with SM clients, trained professionals, or conducted SM research</span> — you have expertise our community needs.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
              As a ClaimYourVoice Specialist, you will:
            </p>
            <div className="space-y-4">
              {[
                { icon: "💼", title: "Offer paid lessons, workshops, or structured courses" },
                { icon: "📈", title: "Set your own pricing and availability" },
                { icon: "📝", title: "Receive a public coaching profile so members can book you" },
                { icon: "🤝", title: "Benefit from guide referrals who guide members internally" },
            ...
            <Card className="mt-8 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
              <CardContent className="p-6">
                <p className="text-slate-700 dark:text-slate-300 text-lg">
                  Members browse the specialist catalog, compare expertise, and book you directly based on need and guide recommendation.
                </p>
          ...
          <div className="mb-16">
            ...
            <Card className="border-emerald-200 dark:border-emerald-900/30 bg-emerald-50 dark:bg-emerald-950/20">
              <CardContent className="p-10 space-y-6">
                <div>
                  <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                    <strong>You choose your price.</strong> Members pay your full session rate.
                  </p>
                </div>
                <div>
                  <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                    <strong>ClaimYourVoice retains 20% commission to operate the platform —</strong> you keep 80%.
                  </p>
                </div>
          ...
          {/* Why Specialist */}
          <div className="mb-16">
            <h2 className="text-3xl font-display font-bold mb-8 text-slate-900 dark:text-white">Why Specialist With ClaimYourVoice?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                "Earn money while sharing valuable skills",
                "No client chasing — members come to you",
                "Build your reputation as a trusted expert",
                "Teach real members building real businesses",
            ...
            <Card className="mt-8 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
              <CardContent className="p-6">
                <p className="text-slate-700 dark:text-slate-300 text-lg">
                  For many specialists, <strong>revenue is great — but the real reward is watching members level up through your knowledge.</strong>
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mb-16">
            ...
            <Card className="border-amber-200 dark:border-amber-900/30 bg-amber-50 dark:bg-amber-950/20">
              <CardContent className="p-10">
                <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                  ClaimYourVoice values a positive and reliable coaching experience for all users. If a specialist's rating drops below 3 stars out of 5, we may pause or deactivate the account until quality standards are met again.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          {!showForm ? (
            <div className="bg-gradient-to-r from-cyan-900/50 to-slate-900/50 rounded-2xl p-12 text-center border border-cyan-500/30">
              ...
              <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
                If you want to teach what you know, support members, and get paid on your terms, we'd love to learn more about you.
              </p>
              ...
              <Button size="lg" className="h-14 px-10 text-lg rounded-full bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-semibold" onClick={() => setShowForm(true)} data-testid="button-apply-specialist">
                Apply to Become a Specialist <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </div>
          ) : (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <Input
                        ...
                        data-testid="input-specialist-fullname"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-slate-50 dark:bg-slate-800/50"
                        data-testid="input-specialist-linkedin"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        value={formData.bio}
                        onChange={handleInputChange}
                        placeholder="Tell members about yourself, your background, and what makes you a great specialist. This will be displayed on your public profile."
                        className="bg-slate-50 dark:bg-slate-800/50 min-h-[120px]"
                        data-testid="input-specialist-bio"
                      />
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">This bio will be visible to members browsing specialists</p>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        data-testid="select-specialist-expertise"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        data-testid="select-specialist-focusareas"
                      >
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="e.g., $25"
                            className="bg-slate-50 dark:bg-slate-800/50"
                            data-testid="input-specialist-introcallrate"
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="e.g., $150"
                            className="bg-slate-50 dark:bg-slate-800/50"
                            data-testid="input-specialist-sessionrate"
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="e.g., $500"
                            className="bg-slate-50 dark:bg-slate-800/50"
                            data-testid="input-specialist-monthlyrate"
                          />
                        </div>
                        <div>
                          ...
                          <Textarea
                            ...
                            data-testid="input-specialist-monthly-retainer-description"
                          />
                        </div>
                        <p className="text-xs text-slate-500 dark:text-slate-400">ClaimYourVoice retains 20% commission — you keep 80% of your earnings</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        data-testid="select-specialist-country"
                      >
                    ...
                    {formData.country === "United States" && (
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                          data-testid="select-specialist-state"
                        >
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input
                            ...
                            className="bg-slate-50 dark:bg-slate-800/50"
                            data-testid="input-specialist-external-platform"
                          />
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <Input
                              ...
                              placeholder="e.g., 4.9"
                              className="bg-slate-50 dark:bg-slate-800/50"
                              data-testid="input-specialist-external-rating"
                            />
                          </div>
                          <div>
                            ...
                            <Input
                              ...
                              placeholder="e.g., 37"
                              className="bg-slate-50 dark:bg-slate-800/50"
                              data-testid="input-specialist-external-review-count"
                            />
                          </div>
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            onChange={handleInputChange}
                            placeholder="https://mentorcruise.com/guide/yourname"
                            className="bg-slate-50 dark:bg-slate-800/50"
                            data-testid="input-specialist-external-url"
                          />
                          <p className="text-xs text-amber-600 dark:text-amber-400 mt-1">This link will never be shown to members - it's only for our team to verify your ratings.</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-6 border-t border-slate-200 dark:border-slate-700">
                      ...
                      <div className="flex items-start gap-3 mt-4">
                        <Checkbox
                          ...
                          data-testid="checkbox-specialist-contract"
                        />
                        <label
                    ...
                    <div className="flex gap-3 pt-6">
                      <Button variant="outline" className="flex-1" onClick={() => setShowForm(false)} data-testid="button-cancel-specialist-form">Cancel</Button>
                      <Button type="submit" className="flex-1 bg-cyan-600 hover:bg-cyan-700" disabled={!contractAgreed} data-testid="button-submit-specialist-form">Submit Application</Button>
                    </div>
                  </form>
                )}
              </CardContent>
