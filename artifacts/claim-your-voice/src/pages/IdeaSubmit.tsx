...
export default function IdeaSubmit() {
  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      setResult({
        pitch: "A platform that democratizes journey success by combining instant AI personal action planning with accessible human mentorship.",
        summary: "ClaimYourVoice bridges the gap between raw ideas and funded businesses. It leverages a hybrid AI engine to restructure vague concepts into actionable personal action plans while simultaneously providing a marketplace for experienced guides to guide early-stage members.",
            ...
            <CardContent className="p-6 h-full relative">
              ...
              {isAnalyzing && (
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <p className="mt-4 text-cyan-600 font-medium animate-pulse">Structuring your personal action plan...</p>
                </div>
              )}
