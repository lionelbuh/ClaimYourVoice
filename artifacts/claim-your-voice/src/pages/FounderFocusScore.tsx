...
export default function FounderFocusScore() {
  ...
  const handleAnswer = (answerIndex: number) => {
    ...
    if (currentQuestion < questions.length - 1) {
      ...
      try {
        fetch(`${API_BASE_URL}/api/member-focus-completed`, {
          method: "POST",
        ...
        <section className="pt-20 pb-12 md:pt-24 md:pb-16" style={{ backgroundColor: "#FAF9F7" }}>
          <div className="container px-4 mx-auto max-w-3xl text-center">
            ...
            <p className="text-xl md:text-2xl font-display font-medium mb-4" style={{ color: "#4B3F72" }}>
              Discover your biggest SM blocker in under five minutes.
            </p>
            <p className="text-lg max-w-2xl mx-auto leading-relaxed mb-10" style={{ color: "#4A4A4A" }}>
              Answer 8 personalized questions based on your SM profile and get a clear picture of what is holding you back — plus one concrete, compassionate step to take this week.
            </p>
        ...
        <section className="py-16 md:py-20" style={{ backgroundColor: "#F3F3F3" }}>
          <div className="container px-4 mx-auto max-w-4xl">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                { num: "1", title: "Tell us", desc: "Select the profile that best describes your SM situation." },
                { num: "2", title: "Answer", desc: "Respond to 8 short, personalized questions about your current SM challenges." },
                { num: "3", title: "Discover", desc: "See your primary SM blocker across four key areas of your journey." },
                { num: "4", title: "Act", desc: "Receive one clear, compassionate action step to take this week." },
              ].map((step) => (
        ...
        <div className="container mx-auto px-4 py-12 flex-1 flex flex-col max-w-3xl">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <p className="text-lg mb-10" style={{ color: "#8A8A8A" }}>
              Enter your details below so we can save your SM Journey Score and set up your free dashboard.
            </p>
                ...
                <div className="max-w-md mx-auto rounded-xl p-8" style={{ backgroundColor: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)" }} data-testid="text-auto-signup-success">
                  ...
                  <div className="rounded-lg p-4 mb-4" style={{ backgroundColor: "rgba(245,197,66,0.15)", border: "1px solid rgba(245,197,66,0.3)" }}>
                    ...
                    <p className="text-sm" style={{ color: "rgba(255,255,255,0.9)" }}>
                      Open the email from ClaimYourVoice and click <strong>"Set Your Password & Log In"</strong> to create your password and access your dashboard.
                    </p>
                  </div>
            ...
            <div className="container px-4 mx-auto max-w-3xl">
              <div className="text-center">
                ...
                <h3 className="text-2xl md:text-3xl font-display font-bold text-white mb-3" data-testid="text-community-cta">
                  Join the Free Member Community
                </h3>
                <p className="mb-8 max-w-xl mx-auto leading-relaxed" style={{ color: "rgba(255,255,255,0.8)" }}>
                  Sign up with your email and password to unlock your dashboard. Access clarity and focus tools, priority-setting exercises, and connect with specialists and other members to accelerate your next steps.
                </p>
                <div className="grid grid-cols-3 gap-3 max-w-md mx-auto mb-8">
                  {[
                    { label: "Focus tools", icon: <Target className="h-4 w-4" /> },
                    { label: "Specialist access", icon: <CheckCircle className="h-4 w-4" /> },
                ...
                {!accountCreated ? (
                  ...
                  <div className="max-w-md mx-auto rounded-xl p-6" style={{ backgroundColor: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)" }} data-testid="text-signup-success">
                    ...
                    <p className="text-sm mb-4" style={{ color: "rgba(255,255,255,0.8)" }}>
                      Your account is ready. Log in to access your member dashboard.
                    </p>
                    <Link href="/login">
                      <Button
