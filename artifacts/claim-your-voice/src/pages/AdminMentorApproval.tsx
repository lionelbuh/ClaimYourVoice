...
export default function AdminMentorApproval() {
  ...
  const handleApprove = (index: number) => {
    ...
    // Also save to guide profile so they can access dashboard
    const mentorProfile = {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-display font-bold text-slate-900 dark:text-white mb-2">Admin: Guide Applications</h1>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex gap-2 pt-4 border-t border-slate-200 dark:border-slate-700">
                        <Button 
                          ...
                          data-testid={`button-approve-guide-${actualIndex}`}
                        >
                        ...
                        <Button 
                          ...
                          data-testid={`button-reject-guide-${actualIndex}`}
                        >
        ...
        {approvedApplications.length > 0 && (
          <div className="mb-8">
            <h2 className="text-2xl font-display font-bold text-slate-900 dark:text-white mb-4">Approved Guides</h2>
            <div className="space-y-4">
        ...
        {applications.length === 0 && (
          <Card className="border-slate-200 dark:border-slate-700">
            <CardContent className="pt-12 pb-12 text-center">
              <p className="text-muted-foreground">No guide applications yet</p>
            </CardContent>
          </Card>
        )}
      </div>
