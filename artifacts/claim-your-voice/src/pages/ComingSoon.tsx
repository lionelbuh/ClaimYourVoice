      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-300 leading-relaxed">
            Our team is currently working hard to finalize the AI guidance system that will support members and connect them with guides through ClaimYourVoice.
          </p>
        </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700 mb-8 overflow-hidden">
          <CardContent className="p-8">
            <p className="text-slate-200 leading-relaxed">
              We're preparing the platform carefully to ensure it's reliable, helpful, and ready to welcome ambitious members like you.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-300 mb-8 text-lg">
            You can pre-register for free today. Enter your email below, and we'll notify you as soon as the AI system is ready for you to join, explore, and start working with guides.
          </p>
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-3">
              ...
              <p className="text-slate-200">
                <strong>🔔 You'll be the first to know</strong> when we go live and the full ClaimYourVoice platform is ready for you to start your journey.
              </p>
            </div>
          </CardContent>
        </Card>
