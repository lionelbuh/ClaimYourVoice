...
export default function MentorWaitlist() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/guide-waitlist`, {
        method: "POST",
        headers: {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-300 leading-relaxed">
            We're grateful for the incredible response from experienced guides like you. Right now, we have all the guides we need to support our current members.
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-200 leading-relaxed">
                  Your willingness to guide members means the world to us. We're building something special here, and guides like you are at the heart of it.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        {!submitted ? (
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold">Join Our Guide Waiting List</h2>
            </div>
            <p className="text-slate-300 mb-8 text-lg">
              As we grow and welcome more members, we'll need more guides. Leave your details below, and we'll reach out when a spot opens up.
            </p>
          ...
          <Card className="bg-gradient-to-r from-indigo-500/20 to-cyan-500/20 border-indigo-500/30 mb-12">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-slate-200">
                Thank you for joining our guide waiting list. We'll be in touch as soon as a spot becomes available.
              </p>
            </CardContent>
          </Card>
        )}
        ...
        <Card className="bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 border-indigo-500/30">
          <CardContent className="p-6">
            <div className="flex items-start gap-3">
              ...
              <p className="text-slate-200">
                <strong>We value quality over quantity.</strong> Each guide in our network receives dedicated support and meaningful connections with members who are ready to grow.
              </p>
            </div>
          </CardContent>
        </Card>
