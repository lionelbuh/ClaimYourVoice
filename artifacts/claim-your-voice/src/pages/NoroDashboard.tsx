        ...
        <Card className={`bg-slate-800/50 border-slate-700 ${isNoro ? "border-l-4 border-l-blue-500" : "border-l-4 border-l-emerald-500"}`}>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              {!isNoro && (
                <div>
                  <Label className="text-slate-300 text-xs">Members Contractor Threshold</Label>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              ...
              <tbody>
                ...
                <CashRow label="Member Repayments" data={data} field="founderRepayments" currency={currency} total={totals.founderRepayments} />
