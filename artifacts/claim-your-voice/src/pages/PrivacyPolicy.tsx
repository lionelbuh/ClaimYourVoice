          ...
          <div className="space-y-8">
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  Touch Equity Partners LLC ("Company", "we", "us", "our") operates ClaimYourVoice.com and the ClaimYourVoice service (collectively, "ClaimYourVoice"), which is a brand and service of Touch Equity Partners LLC.
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  By using ClaimYourVoice, you agree to the collection and use of information in accordance with this Privacy Policy.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-slate-700 dark:text-slate-300 mb-2">When you create an account as a specialist, member or guide, we may collect:</p>
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2 mb-4">
                  <li>Provide, operate, and maintain ClaimYourVoice</li>
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  We use trusted third-party providers to operate ClaimYourVoice, including:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2 mb-4">
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  To exercise these rights, contact us at: <a href="mailto:hello@claimyourvoice.org" className="text-cyan-600 hover:underline">hello@claimyourvoice.org</a>
                </p>
              </CardContent>
            </Card>
