...
export default function RateCoach() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/api/specialist-ratings`, {
        method: "POST",
      ...
      <div className="container mx-auto max-w-2xl">
        {submitted ? (
          ...
          <Card className="border-cyan-200 dark:border-cyan-900/30">
            <CardHeader>
              <CardTitle className="text-3xl font-display text-center">Rate Your Specialist</CardTitle>
            </CardHeader>
            <CardContent>
              {coachName && (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Share your feedback about this specialist's expertise, communication, and value delivered..."
