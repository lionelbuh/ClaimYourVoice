          ...
          <div className="space-y-8">
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  Welcome to ClaimYourVoice.com.
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  ClaimYourVoice is a brand and online service operated by Touch Equity Partners LLC ("Company", "we", "us", "our").
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  By accessing or using our website, creating an account, booking a specialist, or purchasing a membership, you agree to these Terms & Conditions and our associated policies. If you do not agree, you must discontinue use of the platform.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  ClaimYourVoice connects members with guides, specialists, experts, and educational resources to support business development and growth.
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2 mb-4">
                  ...
                  <li>Guide and specialist profile placement, subject to approval</li>
                  <li>Paid one-on-one and group coaching access</li>
                  <li>Supporter pitch preparation support</li>
                  <li>Tools and resources for strategy, learning, and growth</li>
                </ul>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed font-semibold">
                  ClaimYourVoice provides guidance and access to expertise. We do not guarantee business success, coaching outcomes, revenue growth, or supporter funding decisions.
                </p>
              </CardContent>
            </Card>
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="text-slate-700 dark:text-slate-300">
                      Membership begins only after your project has been reviewed and accepted by a guide or specialist on the platform.
                    </p>
                  </div>
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                <h2 className="text-2xl font-display font-bold mb-4 text-slate-900 dark:text-white">4. Guide Availability and Changes</h2>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  We aim to support continuity in mentorship relationships. However, guide assignments may change due to:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2 mb-4">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  If a change is required, ClaimYourVoice will assist in transitioning you to another appropriate guide when possible.
                </p>
              </CardContent>
            </Card>
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2">
                      ...
                      <li>To request a refund within this period, you must contact us at hello@claimyourvoice.org</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2">
                      <li>Coaching sessions are provided by independent guides and specialists</li>
                      <li>These services are not included in the membership fee</li>
                      <li>Specialists are solely responsible for approving or denying refund requests for their services</li>
                      <li className="font-semibold">ClaimYourVoice retains a non-refundable 20 percent platform commission for providing access to the specialist network and infrastructure. This service fee is not reimbursable under any circumstances.</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  By using ClaimYourVoice, you agree to our Privacy Policy, which explains how personal data is collected, used, and protected. This may include information such as your name, email address, usage data, and cookies.
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  All branding, software, content, guides, templates, materials, and digital assets associated with ClaimYourVoice are the exclusive property of Touch Equity Partners LLC.
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  ClaimYourVoice may help members prepare supporter materials and facilitate introductions. However:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2 mb-4">
                  <li>Investment decisions are made independently by supporters</li>
                  <li>Funding is never guaranteed</li>
                  <li>Results depend on execution, readiness, and external factors</li>
                </ul>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed font-semibold">
                  ClaimYourVoice is not a lender, broker, or funding provider.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-200 dark:border-slate-700 bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-900/30">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  Touch Equity Partners LLC and ClaimYourVoice are not liable for:
                </p>
                <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-2 mb-4">
                  <li>Business losses or performance outcomes</li>
                  <li>Investment acceptance or rejection</li>
                  <li>Disputes between users and specialists</li>
