...
const guides = [
  {
    ...
    role: "Ex-YCombinator Member",
    category: "Business Strategy",
    specialties: ["SaaS", "Fundraising", "Product Market Fit"],
    rating: 4.9,
    image: "https://i.pravatar.cc/150?u=elena",
    bio: "I help early stage members navigate the chaos of the first 12 months. Sold my last SaaS for $10M."
  },
  {
    id: 2,
    name: "David Chen",
  ...
  },
  {
    ...
    bio: "Written checks for 20+ journeys. I know what supporters want to see in your deck and financial models."
  },
  {
    id: 5,
    name: "Anita Patel",
  ...
  },
  {
    ...
    bio: "Protect your IP from day one. Expert in journey law and member agreements."
  }
];
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
          <div>
            <h1 className="text-4xl font-display font-bold text-slate-900 dark:text-white mb-2">Specialized Guide Marketplace</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {guides.map((guide) => (
            <Card key={guide.id} className="group hover:shadow-lg transition-all duration-300 border-slate-200 dark:border-slate-800 overflow-hidden">
              <CardHeader className="p-0">
                <div className="h-24 bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 relative">
                  <div className="absolute top-4 right-4 bg-white/90 dark:bg-slate-900/90 backdrop-blur px-2 py-1 rounded text-xs font-bold flex items-center gap-1 shadow-sm">
                    <Star className="h-3 w-3 text-yellow-500 fill-yellow-500" /> {guide.rating}
                  </div>
              ...
              <CardContent className="px-6 pt-0 pb-4 relative">
                ...
                <div className="mt-3">
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors">{guide.name}</h3>
                  <p className="text-sm font-medium text-slate-500 flex items-center gap-1 mb-3">
                    <Briefcase className="h-3 w-3" /> {guide.role}
                  </p>
