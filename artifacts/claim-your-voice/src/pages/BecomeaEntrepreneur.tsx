...
const generateAIReview = (formData: any) => {
  return {
    ...
    personalSkills: formData.personalSkills || "Member skills profile pending",
    ...
    investorType: formData.investorType || "Supporter preference not specified",
...
const generateBusinessPlan = (formData: any) => {
  return {
    ...
    fundingRequirements: `Total Funding Needed: ${formData.fundingNeeded || "$500K seed round"}}. Use of Funds: Engineering/Product ($250K), Sales & Marketing ($150K), Operations ($100K). Current Stage: ${formData.currentStage || "MVP stage"}}. Previous Investment: ${formData.personalInvestment || "member investment already deployed"}}. Prior Funding: ${formData.externalFunding || "no external funding to date"}}. Supporter Profile: ${formData.investorType || "seed-stage venture capital and angels"}}. Timeline: Seeking capital immediately. Team: ${formData.soloOrCoFounders || "experienced members"}} with ${formData.personalSkills || "complementary expertise"}}.`,
...
export default function BecomeaEntrepreneur() {
  ...
  const handleApproveIdeaAndContinue = async () => {
    ...
    try {
      ...
      // Use the AI-enhanced answers (editedReview) for the personal action plan
      const answers: Record<string, string> = {};
      ...
      toast.success("AI has generated your personal action plan!");
    } catch (error: any) {
      console.error("[AI BUSINESS PLAN] Error:", error);
      toast.error("Personal action plan generation failed. Using template.");
  ...
  const handleSubmitApplication = async () => {
    ...
    try {
      ...
      try {
        ...
        console.log("[CONTRACT] Member agreement saved");
      } catch (contractError) {
  ...
  const handleEditBusinessPlan = () => {
    const planText = `# Personal Action Plan: ${formData.ideaName}
...
**Break-even:** Month 18-24 (typical for SaaS journeys)
...
**Note:** This is an AI-generated draft. Please edit, customize, and add specific numbers, timeline, and details unique to your situation.`;
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen">
        ...
        <DialogContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-4 py-6">
            ...
            <p className="text-center text-base text-slate-600 dark:text-slate-400">
              Our team will review your SM journey submission and voice plan within <strong>24-48 hours</strong>. Once approved and you've activated your membership, you can log in to your full dashboard and connect with your SM Guide and specialists!
            </p>
          </div>
          <Button
            ...
            data-testid="button-thank-you-ok-member"
          >
            I Understand
          </Button>
        </DialogContent>
      ...
      {/* Hero Section */}
      <section className="py-16 bg-gradient-to-b from-emerald-900/30 to-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <Badge variant="secondary" className="mb-6 px-6 py-3 text-lg bg-emerald-500/10 text-emerald-600 dark:text-emerald-300 border-emerald-500/30">
              <Lightbulb className="inline-block mr-2 h-4 w-4" /> Begin Your SM Journey
            </Badge>
            <h1 className="text-4xl md:text-5xl font-display font-bold mb-6 text-slate-900 dark:text-white">
              Apply as an SM Warrior
            </h1>
            <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
              Share your SM journey and get matched with guides, specialists, and supporters who understand — and can help you find your voice.
            </p>
          </div>
        </div>
      </section>
          ...
          <Card className="mb-12 -mt-8 border-emerald-200 dark:border-emerald-900/30 bg-emerald-50 dark:bg-emerald-950/20">
            <CardContent className="p-10">
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                ClaimYourVoice connects SM Warriors with experienced SM Guides, clinical Specialists, and compassionate Supporters. Share your SM journey, build your personal voice plan, and — once approved — join a growing community focused on real progress, meaningful connection, and lasting change.
              </p>
            </CardContent>
          </Card>
            ...
            <Card className="border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
              <CardContent className="p-10 space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Share Your SM Journey</h3>
                    <p className="text-slate-700 dark:text-slate-300">Tell us about your experience with Selective Mutism, your current challenges, and what you hope to achieve on your journey.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Build Your Voice Plan</h3>
                    <p className="text-slate-700 dark:text-slate-300">Develop a personal action plan that maps your SM goals, milestones, and the support you need to move forward — guided by AI and refined with care.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Get Approved & Activate</h3>
                    <p className="text-slate-700 dark:text-slate-300">Our team carefully reviews your submission within 24–48 hours. Once approved, activate your membership to unlock full access to the SM Warriors community.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Connect & Find Your Voice</h3>
                    <p className="text-slate-700 dark:text-slate-300">Get matched with an SM Guide, access clinical Specialists, and connect with a community of Supporters who believe in your journey and celebrate every breakthrough.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          {!showForm ? (
            ...
            <Card className="border-slate-200 dark:border-slate-700 mb-16">
              <CardContent className="p-10">
                  ...
                  <div className="space-y-6" data-section="ai-review">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h2 className="text-3xl font-display font-bold text-slate-900 dark:text-white">Comprehensive Review of Your SM Journey – All 42 Questions</h2>
                      </div>
                      <p className="text-slate-600 dark:text-slate-400">Here's a review of your answers. Our AI has helped refine your responses — tweak anything with your own words before building your personal voice plan!</p>
                    </div>

                    <div className="space-y-4">
                      {IDEA_PROPOSAL_QUESTIONS.map((section) => (
                    ...
                    <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-700">
                      <p className="text-sm text-slate-600 dark:text-slate-400">
                        <strong>Edit any section directly above</strong> if you'd like to refine the suggested rephrasing. Then continue building your personal action plan.
                      </p>
                ...
                {/* Personal Action Plan Screen - EDITABLE */}
                {showingBusinessPlan && (
                  <div className="space-y-6" data-section="business-plan">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <Sparkles className="h-6 w-6 text-cyan-600" />
                        <h2 className="text-3xl font-display font-bold text-slate-900 dark:text-white">Your Personal Voice Plan</h2>
                      </div>
                      <p className="text-muted-foreground">Here's your personal voice plan draft. Some sections may need your personal touch — edit each section to make it truly yours.</p>
                    </div>

                    <div className="space-y-6">
                      {[
                        { key: "executiveSummary", label: "Journey Overview" },
                        { key: "problemStatement", label: "My SM Challenge" },
                        { key: "solution", label: "My Approach & Goals" },
                        { key: "targetMarket", label: "My Support Community" },
                        { key: "marketSize", label: "Scope of Impact" },
                        { key: "revenueModel", label: "Resources & Support Needed" },
                        { key: "competitiveAdvantage", label: "My Strengths & Motivations" },
                        { key: "roadmap12Month", label: "12-Month Progress Roadmap" },
                        { key: "fundingRequirements", label: "What I Need from ClaimYourVoice" },
                        { key: "risksAndMitigation", label: "Challenges & How to Overcome Them" },
                        { key: "successMetrics", label: "How I'll Measure Progress" }
                      ].map((section) => (
                        <Card key={section.key} className="border-cyan-200 dark:border-cyan-900/30">
                          <CardHeader className="pb-3 bg-cyan-50/50 dark:bg-cyan-950/20">
                    ...
                    <div className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                      ...
                      {isPreApprovedUser ? (
                        ...
                        <div className="mt-4">
                          <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-3">Member Membership Agreement</h3>
                          ...
                          <div className="flex items-start gap-2 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                            <input 
                              type="checkbox" 
                              id="member-agree-checkbox"
                              checked={agreementAccepted}
                              onChange={(e) => setAgreementAccepted(e.target.checked)}
                              className="mt-1"
                              data-testid="checkbox-member-agree"
                            />
                            <label htmlFor="member-agree-checkbox" className="text-sm text-slate-700 dark:text-slate-300">
                              I have read and agree to the ClaimYourVoice Member Membership Agreement. I understand and accept all terms and conditions.
                            </label>
                          </div>
                        </div>
                      )}
                    ...
                    <form className="space-y-6">
                      {isPreApprovedUser && (
                        <div className="mb-4 p-3 bg-cyan-50 dark:bg-cyan-950/20 border border-cyan-200 dark:border-cyan-800 rounded-lg">
                          <p className="text-sm text-cyan-700 dark:text-cyan-400">You're submitting your personal journey as a Community Free member. Your name and email are pre-filled from your account.</p>
                        </div>
                      )}
                      <div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleInputChange}
                          placeholder="Tell us about yourself: Who are you? What motivates you to be an member? Are you working solo or with a team? Share your background and passion..."
                          ...
                          data-testid="textarea-member-fullbio"
                        />
                        <p className="text-xs text-slate-500 mt-1">Share who you are, what motivates you, and whether you're a solo member or part of a team.</p>
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          data-testid="select-member-country"
                        >
                          {COUNTRIES.map(c => (
                      ...
                      {formData.country === "United States" && (
                        <div>
                          ...
                          <select
                            ...
                            onChange={handleInputChange}
                            className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white"
                            data-testid="select-member-state"
                          >
                      ...
                      <div className="flex gap-3 pt-8 border-t border-slate-200 dark:border-slate-700">
                        <Button
                          ...
                          className="flex-1"
                          data-testid="button-member-cancel"
                        >
                          Cancel
                        </Button>
                        <Button
                          ...
                          onClick={handleNext}
                          className="flex-1 bg-gradient-to-r from-emerald-500 to-emerald-400 hover:from-emerald-400 hover:to-emerald-300 text-white font-semibold"
                          data-testid="button-member-next"
                        >
                ...
                {!showingAiReview && !showingBusinessPlan && currentStep === 1 && (
                  <div className="space-y-6" data-section="step-2">
                    <div>
                      <h2 className="text-3xl font-display font-bold mb-2 text-slate-900 dark:text-white">Step 2: Tell Us About Your SM Journey</h2>
                      <p className="text-slate-600 dark:text-slate-400 mb-6">Help us understand your experience with Selective Mutism and where you want to go</p>
                    ...
                    <form className="space-y-6">
                      ...
                      <div className="border-l-4 border-emerald-500 pl-6">
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Your SM Challenge & Background</h3>
                        <div className="space-y-4">
                      ...
                      <div className="border-l-4 border-blue-500 pl-6">
                        ...
                        <div className="space-y-4">
                          <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-2">Project/Company name on ClaimYourVoice? *</label>
                      ...
                      <div className="border-l-4 border-red-500 pl-6">
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Member Profile</h3>
                        <div className="space-y-4">
                          <div data-field="foundedBefore">
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-2">Have you founded or launched a journey before? *</label>
                          ...
                          <div data-field="soloOrCoFounders">
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-2">Solo or with co-members? *</label>
                            <select name="soloOrCoFounders" value={formData.soloOrCoFounders} onChange={handleInputChange} className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white" data-testid="select-members" data-field="soloOrCoFounders">
                              <option value="">Select...</option>
                              <option value="Solo">Solo</option>
                              <option value="2 co-members">2 co-members</option>
                              <option value="3+ co-members">3+ co-members</option>
                            </select>
                          </div>
                      ...
                      <div className="border-l-4 border-yellow-500 pl-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div data-field="investorType">
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-2">What type of supporters are you looking for?</label>
                            <Input name="investorType" value={formData.investorType} onChange={handleInputChange} placeholder="Supporter types..." className="w-full" data-testid="input-supporters" data-field="investorType" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="border-l-4 border-green-500 pl-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div data-field="mentorHelp">
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-2">What help do you need from guides?</label>
                            <textarea name="mentorHelp" value={formData.mentorHelp} onChange={handleInputChange} placeholder="Guide support..." rows={2} className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder:text-slate-500" data-testid="textarea-guide-help" />
                          </div>
                      ...
                      <div className="flex gap-3 pt-8 border-t border-slate-200 dark:border-slate-700">
                        <Button
                          ...
                          onClick={handlePrevious}
                          className="flex-1"
                          data-testid="button-member-previous"
                        >
                          <ChevronLeft className="mr-2 h-4 w-4" /> Previous
                        </Button>
                        <Button
                          ...
                          data-testid="button-member-review"
                        >
                          {isLoadingAI ? (
                            <>
