...
const audienceCards = [
  {
    icon: Lightbulb,
    title: "Members with an idea and no clear roadmap",
  ...
  {
    icon: Compass,
    title: "First-time members seeking experienced guidance",
  ...
  {
    icon: Rocket,
    title: "Early-stage journeys preparing to launch or scale",
...
const tagColors: Record<string, { bg: string; color: string }> = {
  ...
  "First-time member": { bg: "rgba(75,63,114,0.1)", color: "#4B3F72" },
  "Early-stage journey": { bg: "rgba(13,86,108,0.1)", color: "#0D566C" },
};

export default function Insights() {
  useEffect(() => {
    document.title = "Journey Radar – Insights for Members and Early-Stage Journeys | ClaimYourVoice";
    setMetaTag("description", "Practical operational guidance for first-time members and early-stage journeys. Frameworks for decision clarity, execution systems, and operational discipline.");
    setMetaTag("og:title", "Journey Radar – Insights for Members and Early-Stage Journeys | ClaimYourVoice");
    setMetaTag("og:description", "Practical operational guidance for first-time members and early-stage journeys. Frameworks for decision clarity, execution systems, and operational discipline.");
    setMetaTag("og:type", "website");
    setMetaTag("og:url", "https://www.claimyourvoice.org/insights");
  }, []);
      ...
      <section className="pt-20 pb-12 md:pt-24 md:pb-16" style={{ backgroundColor: "#FAF9F7" }} data-testid="section-insights-hero">
        <div className="container px-4 mx-auto max-w-4xl">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold leading-snug tracking-tight mb-6" style={{ color: "#0D566C" }} data-testid="text-insights-h1">
            Operational Guidance for First-Time Members and Early-Stage Journeys
          </h1>
          <p className="text-lg md:text-xl leading-relaxed max-w-3xl mb-10" style={{ color: "#4A4A4A" }}>
            This page provides practical operational guidance for members with ideas, members launching their first venture, and journeys preparing to scale. Every article is designed to help you make better decisions and take your next step with confidence.
          </p>
          <Link href={`/insights/${insightArticles[0].slug}`} data-testid="link-explore-insights">
            ...
            >
              Explore Journey Radar <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </Link>
        </div>
      </section>
        ...
        <div className="container px-4 mx-auto max-w-5xl">
          <div className="text-center mb-14">
            ...
            <p style={{ color: "#4A4A4A" }}>
              Practical guidance for every stage of your member journey
            </p>
          </div>
          ...
          <div className="flex items-start gap-4 mb-12">
            ...
            <div>
              ...
              <p className="leading-relaxed" style={{ color: "#4A4A4A" }}>
                ClaimYourVoice focuses on three pillars that define operational readiness for early-stage members:
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { label: "Operational Discipline", desc: "Develop the habits and structures that separate members who ship from those who stall." }
            ].map((fw, i) => (
              <div
                key={i}
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: "#0D566C" }} data-testid="section-insights-cta">
        <div className="container px-4 mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg mb-10 leading-relaxed max-w-2xl mx-auto" style={{ color: "rgba(255,255,255,0.85)" }}>
            ClaimYourVoice supports members at different stages with hands-on operational guidance from experienced operators. No pitch required. Just a willingness to take the next step.
          </p>
          <Link href="/member-focus" data-testid="link-insights-talk">
            <Button
              size="lg"
              className="h-14 px-10 text-lg font-semibold rounded-full shadow-lg transition-all duration-200 hover:shadow-xl hover:scale-[1.03] active:scale-[0.98]"
              style={{ backgroundColor: "#FF6B5C", color: "#FFFFFF", border: "none" }}
