        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              ClaimYourVoice is a website and service operated by Touch Equity Partners LLC.
            </p>
          </div>
        </div>
      </section>
              ...
              <CardContent className="p-8">
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                  ...
                  <p className="text-slate-700 dark:text-slate-300 mb-3">
                    We use Google Analytics to understand how visitors use ClaimYourVoice. These cookies may collect:
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-slate-700 dark:text-slate-300 ml-2">
                    <li>Pages visited</li>
            ...
            <Card className="border-slate-200 dark:border-slate-700">
              <CardContent className="p-8">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  When you first visit ClaimYourVoice, you see a cookie banner that lets you:
                </p>
