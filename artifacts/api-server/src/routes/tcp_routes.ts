  ...
  try {
    if (process.env.RESEND_API_KEY) {
      ...
      return {
        ...
        fromEmail: process.env.RESEND_FROM_EMAIL || "hello@claimyourvoice.org"
      };
    }
    ...
    return {
      ...
      fromEmail: connectionSettings.settings.from_email || "hello@claimyourvoice.org"
    };
  } catch (error) {
...
async function sendPaymentWelcomeEmail(email: string, fullName: string) {
  ...
  const FRONTEND_URL = process.env.FRONTEND_URL || (process.env.NODE_ENV === "development" ? "http://localhost:5000" : "https://claimyourvoice.org");
  
  const subject = "Welcome to ClaimYourVoice - Your Membership is Active!";
  const htmlContent = `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="background-color: #FAF9F7;">
      <div class="container">
        ...
        <div class="content">
          <p>Congratulations! Your payment has been confirmed and your ClaimYourVoice membership is now <strong style="color: #0D566C;">active</strong>!</p>
          ...
          <p>Best regards,<br>The ClaimYourVoice Team</p>
        </div>
        <div class="footer">
          <p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC. All rights reserved.<br><span style="font-size: 12px;">ClaimYourVoice is a brand and online service operated by ClaimYourVoice LLC.</span></p>
        </div>
      </div>
    </body>
    </html>
...
async function sendStatusEmail(email: string, fullName: string, userType: string, status: string, applicationId: string, wasPreApproved: boolean = false) {
  ...
  if (status === "approved") {
    ...
    if (userType === "entrepreneur" && wasPreApproved) {
      subject = `Congratulations! Your ClaimYourVoice Membership is Now Active!`;
      htmlContent = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="background-color: #FAF9F7;">
          <div class="container">
            ...
            <div class="content">
              <p>Great news! Your membership to ClaimYourVoice has been <strong style="color: #0D566C;">fully activated</strong>!</p>
      ...
      subject = `Welcome to ClaimYourVoice - Your ${userType.charAt(0).toUpperCase() + userType.slice(1)} Application is Approved!`;
      htmlContent = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="background-color: #FAF9F7;">
          <div class="container">
            ...
            <div class="content">
              <p>Great news! Your application to join ClaimYourVoice as a <strong>${userType}</strong> has been <strong style="color: #0D566C;">approved</strong>!</p>
              ...
              <p style="font-size: 14px; color: #8A8A8A;">This link will expire in 7 days. If you didn't apply to ClaimYourVoice, please ignore this email.</p>
    ...
    subject = `ClaimYourVoice - Your Application is Pre-Approved! Complete Your Membership`;
    htmlContent = `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body style="background-color: #FAF9F7;">
        <div class="container">
          ...
          <div class="content">
            <p>Your application to join ClaimYourVoice as an <strong>entrepreneur</strong> has been <strong style="color: #F5C542;">pre-approved</strong>!</p>
    ...
    subject = `ClaimYourVoice - Application Update`;
    htmlContent = `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body style="background-color: #FAF9F7;">
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Thank you for your interest in joining ClaimYourVoice as a <strong>${userType}</strong>.</p>
...
export async function registerRoutes(
  ...
  app.get("/sitemap.xml", async (_req, res) => {
    try {
      const baseUrl = "https://www.claimyourvoice.org";
  ...
  app.get("/api/seo/mentor-schema/:mentorId", async (req, res) => {
    try {
      ...
      const schema = {
        ...
        "url": `https://www.claimyourvoice.org/mentors/${slug}`,
  ...
  app.get("/api/seo/coach-schema/:coachId", async (req, res) => {
    try {
      ...
      const schema = {
        ...
        "url": `https://www.claimyourvoice.org/coaches/${slug}`,
          ...
          try {
            ...
            if (resendData) {
              ...
              await resendClient.emails.send({
                from: fromEmail,
                to: email,
                subject: "Idea Submission Received - ClaimYourVoice",
                html: `
                    <!DOCTYPE html>
                    <html>
                    <head>
                    ...
                    <body style="background-color: #FAF9F7;">
                      <div class="container">
                        ...
                        <div class="content">
                          <p>Hi ${fullName},</p>
                    <p>Thank you for submitting your business idea${emailIdeaName !== "their business idea" ? ` "<strong>${emailIdeaName}</strong>"` : ""} to ClaimYourVoice.</p>
                    ...
                    <p><a href="https://claimyourvoice.org/login" style="display: inline-block; background-color: #FF6B5C; color: white; padding: 12px 24px; border-radius: 25px; text-decoration: none; font-weight: bold;">Log In to Your Dashboard</a></p>
              ...
              await resendClient.emails.send({
                ...
                html: `
                    ...
                    <p><a href="https://claimyourvoice.org/admin-dashboard" style="display: inline-block; background-color: #FF6B5C; color: white; padding: 12px 24px; border-radius: 25px; text-decoration: none; font-weight: bold;">Review in Admin Dashboard</a></p>
      ...
      try {
        ...
        if (resendData) {
          ...
          await resendClient.emails.send({
            from: fromEmail,
            to: email,
            subject: "Application Received - ClaimYourVoice Entrepreneur",
            html: `
                    <!DOCTYPE html>
                    <html>
                    <head>
                    ...
                    <body style="background-color: #FAF9F7;">
                      <div class="container">
                        ...
                        <div class="content">
                          <p>Hi ${fullName},</p>
                <p>Thank you for submitting your application to join ClaimYourVoice as an <strong>Entrepreneur</strong>${emailIdeaName2 !== "their business idea" ? ` for "<strong>${emailIdeaName2}</strong>"` : ""}.</p>
                <p>Our team will review your submission and get back to you shortly. You'll receive an email once your application has been reviewed.</p>
                <p>In the meantime, feel free to explore our resources and community.</p>
                <p><a href="https://claimyourvoice.org" style="display: inline-block; background-color: #FF6B5C; color: white; padding: 12px 24px; border-radius: 25px; text-decoration: none; font-weight: bold;">Visit ClaimYourVoice</a></p>
  ...
  app.put("/api/entrepreneurs/intake/:email", async (req, res) => {
    try {
      ...
      if (resendData) {
        ...
        const needsList = needsIntake ? (needsIntake.needs || []).map((n: string) => `<li style="margin-bottom:6px;">${n}</li>`).join("") : "";
        const focusStepsList = snapshotSummary ? (snapshotSummary.focusSteps || []).map((s: string, i: number) => `<li style="margin-bottom:6px;"><strong>Step ${i + 1}:</strong> ${s}</li>`).join("") : "";

        const needsSection = needsIntake ? `<div style="margin-bottom:24px;"><h2 style="font-size:18px;color:#0D566C;margin:0 0 12px 0;border-bottom:2px solid #F5C542;padding-bottom:8px;">What You Need</h2><div style="background:rgba(245,197,66,0.12);border-left:4px solid #F5C542;padding:15px;border-radius:8px;"><p style="margin:0 0 8px 0;font-weight:600;">Your selected needs:</p><ul style="margin:0;padding-left:20px;">${needsList}</ul>${needsIntake.message ? `<p style="margin:10px 0 0 0;font-style:italic;color:#4A4A4A;">&quot;${needsIntake.message}&quot;</p>` : ""}</div></div>` : "";

        const snapshotSection = (founderSnapshot && snapshotSummary) ? `<div style="margin-bottom:24px;"><h2 style="font-size:18px;color:#4B3F72;margin:0 0 12px 0;border-bottom:2px solid #4B3F72;padding-bottom:8px;">Your Founder Snapshot</h2><table width="100%" cellpadding="0" cellspacing="8" style="margin:0 0 15px 0;"><tr><td style="background:#F3F0FA;border-radius:12px;padding:12px;text-align:center;width:33%;"><div style="font-size:11px;color:#8A8A8A;text-transform:uppercase;">Stage</div><div style="font-size:14px;font-weight:600;color:#0D566C;">${snapshotSummary.stage}</div></td><td style="background:#FFF5F4;border-radius:12px;padding:12px;text-align:center;width:33%;"><div style="font-size:11px;color:#8A8A8A;text-transform:uppercase;">Challenge</div><div style="font-size:14px;font-weight:600;color:#0D566C;">${snapshotSummary.mainChallenge}</div></td><td style="background:#FFF8E5;border-radius:12px;padding:12px;text-align:center;width:33%;"><div style="font-size:11px;color:#8A8A8A;text-transform:uppercase;">Traction</div><div style="font-size:14px;font-weight:600;color:#0D566C;">${snapshotSummary.traction}</div></td></tr></table><div style="background:rgba(75,63,114,0.08);border-left:4px solid #4B3F72;padding:15px;border-radius:8px;margin-bottom:12px;"><p style="margin:0 0 8px 0;font-weight:600;">What you're building:</p><p style="margin:0;">${founderSnapshot.building}</p></div><p><strong>Target customer:</strong> ${founderSnapshot.targetCustomer}</p><p><strong>90-day goal:</strong> ${snapshotSummary.ninetyDayGoal || "Not specified"}</p>${focusStepsList ? `<div style="margin-top:12px;"><p style="font-weight:600;margin-bottom:8px;">Your Focus Steps:</p><ol style="padding-left:20px;">${focusStepsList}</ol></div>` : ""}</div>` : "";

        if (needsSection || snapshotSection) {
          try {
            await emailClient.emails.send({
              from: fromEmail,
              to: decodedEmail,
              subject: "Your Smart Founder Snapshot Summary - ClaimYourVoice",
              html: `<!DOCTYPE html><html><head><style>body{font-family:'Inter',Arial,sans-serif;line-height:1.6;color:#4A4A4A;margin:0;padding:0;background-color:#FAF9F7}.container{max-width:600px;margin:0 auto;padding:20px}.header{background:linear-gradient(135deg,#0D566C,#0a4557);color:white;padding:30px;text-align:center;border-radius:16px 16px 0 0}.content{background:#FFFFFF;padding:30px;border-radius:0 0 16px 16px}.button{display:inline-block;background-color:#FF6B5C;color:white;padding:14px 28px;text-decoration:none;border-radius:25px;font-weight:600;margin:20px 0}.footer{text-align:center;margin-top:20px;color:#8A8A8A;font-size:14px}</style></head><body style="background-color:#FAF9F7"><div class="container"><div class="header"><h1 style="margin:0;font-size:24px">Thanks for Sharing, ${entrepreneurName}!</h1><p style="margin:8px 0 0 0;font-size:14px;opacity:0.9;">Here's a summary of everything you submitted.</p></div><div class="content"><p>We've received your responses and our Founder Guidance Team will use this to tailor your experience.</p>${needsSection}${snapshotSection}<p style="text-align:center;margin-top:24px;"><a href="${FRONTEND_URL}/login" class="button">Go to Your Dashboard</a></p><p>Best regards,<br>The ClaimYourVoice Founder Guidance Team</p></div><div class="footer"><p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC. All rights reserved.<br><span style="font-size:12px;">ClaimYourVoice is a brand and online service operated by ClaimYourVoice LLC.</span></p></div></div></body></html>`
            });
            console.log("[COMBINED EMAIL] Entrepreneur notification sent to:", decodedEmail);
          } catch (emailErr: any) {
            console.error("[COMBINED EMAIL] Failed to send entrepreneur email:", emailErr.message);
          }

          const adminNeedsSection = needsIntake ? `<div style="margin-bottom:20px;"><h3 style="color:#F5C542;margin:0 0 8px 0;">Needs Intake</h3><p><strong>Selected needs:</strong></p><ul>${needsList}</ul>${needsIntake.message ? `<p><strong>Additional message:</strong> &quot;${needsIntake.message}&quot;</p>` : ""}</div>` : "";
          const adminSnapshotSection = (founderSnapshot && snapshotSummary) ? `<div style="margin-bottom:20px;"><h3 style="color:#4B3F72;margin:0 0 8px 0;">Founder Snapshot</h3><table width="100%" cellpadding="0" cellspacing="8" style="margin:0 0 15px 0;"><tr><td style="background:#F3F0FA;border-radius:12px;padding:12px;text-align:center;"><div style="font-size:11px;color:#8A8A8A;">STAGE</div><div style="font-weight:600;color:#0D566C;">${snapshotSummary.stage}</div></td><td style="background:#FFF5F4;border-radius:12px;padding:12px;text-align:center;"><div style="font-size:11px;color:#8A8A8A;">CHALLENGE</div><div style="font-weight:600;color:#0D566C;">${snapshotSummary.mainChallenge}</div></td><td style="background:#FFF8E5;border-radius:12px;padding:12px;text-align:center;"><div style="font-size:11px;color:#8A8A8A;">TRACTION</div><div style="font-weight:600;color:#0D566C;">${snapshotSummary.traction}</div></td></tr></table><p><strong>Building:</strong> ${founderSnapshot.building}</p><p><strong>Target Customer:</strong> ${founderSnapshot.targetCustomer}</p><p><strong>90-Day Goal:</strong> ${snapshotSummary.ninetyDayGoal || "Not specified"}</p></div>` : "";

          try {
            await emailClient.emails.send({
              from: fromEmail,
              to: ADMIN_EMAIL,
              subject: `[Smart Founder Snapshot] ${entrepreneurName} completed their submission`,
              html: `<!DOCTYPE html><html><head><style>body{font-family:'Inter',Arial,sans-serif;line-height:1.6;color:#4A4A4A;margin:0;padding:0;background-color:#FAF9F7}.container{max-width:600px;margin:0 auto;padding:20px}.header{background:linear-gradient(135deg,#0D566C,#0a4557);color:white;padding:30px;text-align:center;border-radius:16px 16px 0 0}.content{background:#FFFFFF;padding:30px;border-radius:0 0 16px 16px}.info-box{background:#F5F9FA;border-left:4px solid #0D566C;padding:15px;margin:15px 0;border-radius:8px}.footer{text-align:center;margin-top:20px;color:#8A8A8A;font-size:14px}</style></head><body style="background-color:#FAF9F7"><div class="container"><div class="header"><h1 style="margin:0;font-size:22px">Smart Founder Snapshot Completed</h1></div><div class="content"><div class="info-box"><p style="margin:0;"><strong>Entrepreneur:</strong> ${entrepreneurName}</p><p style="margin:5px 0 0 0;"><strong>Email:</strong> ${decodedEmail}</p></div>${adminNeedsSection}${adminSnapshotSection}<p style="font-size:13px;color:#8A8A8A;">Submitted at: ${new Date().toLocaleString("en-US", { timeZone: "America/Los_Angeles" })} PST</p></div><div class="footer"><p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC</p></div></div></body></html>`
            });
    ...
    try {
      ...
      if (entrepreneur && mentor) {
        ...
        await (client.from("messages").insert({
          from_name: "System",
          from_email: "admin@claimyourvoice.org",
        ...
        try {
          ...
          if (entrepreneur?.entrepreneur_email && mentor) {
            ...
            if (resendData) {
              ...
              const FRONTEND_URL = process.env.FRONTEND_URL || "https://claimyourvoice.org";
        ...
        try {
          ...
          if (resendData) {
            ...
            await resend.emails.send({
              ...
              subject: "Your Mentor Question Has Been Answered - ClaimYourVoice",
              html: `
                    <!DOCTYPE html>
                    <html>
                    <head>
                  ...
                  <div style="background: #FFFFFF; padding: 24px; border-radius: 0 0 16px 16px;">
                    ...
                    <p>A mentor has responded to your question on ClaimYourVoice.</p>
                    ...
                    <a href="${FRONTEND_URL}/login" style="display: inline-block; background-color: #FF6B5C; color: white; padding: 12px 24px; text-decoration: none; border-radius: 25px; font-weight: 600;">Read Full Answer in Dashboard</a>
    ...
    try {
      ...
      const { data, error } = await (client
        ...
        .insert({
          ...
          question: `[Message from ClaimYourVoice Team] ${subject}`,
          status: "answered",
          created_at: new Date().toISOString(),
          admin_reply: message,
          replied_at: new Date().toISOString(),
      ...
      try {
        ...
        if (resendData) {
          ...
          await resend.emails.send({
            ...
            subject: `${subject} - ClaimYourVoice`,
            html: `
              <!DOCTYPE html>
              <html>
              <head>
              ...
              <body style="background-color: #FAF9F7;">
                <div class="container">
                  <div style="background: linear-gradient(135deg, #0D566C, #0a4557); color: white; padding: 24px; border-radius: 16px 16px 0 0; text-align: center;">
                    <h1 style="margin: 0; font-size: 22px;">Message from ClaimYourVoice</h1>
                  </div>
                  <div style="background: #FFFFFF; padding: 24px; border-radius: 0 0 16px 16px;">
                    <p>Hi ${entrepreneurName || "there"},</p>
                    <p>You have a new message from the ClaimYourVoice team:</p>
                    <div style="background: rgba(13,86,108,0.08); border-left: 4px solid #0D566C; padding: 16px; margin: 16px 0; border-radius: 8px;">
  ...
  app.post("/api/mentor-questions/:id/generate-draft", async (req, res) => {
    try {
      ...
      const draftResult = await generateMentorDraftResponse({
        ...
        mentorName: "ClaimYourVoice Mentor"
      });
...
`;
        ...
        if (resendData) {
          await resendData.client.emails.send({
            ...
            html: `
              ...
              <p><a href="https://www.claimyourvoice.org/dashboard/mentor" style="background-color: #FF6B5C;color:white;padding:10px 20px;text-decoration:none;border-radius:25px;display:inline-block;">View in Dashboard</a></p>
              <p>Best,<br>ClaimYourVoice Team</p>
                        </div>
                        <div class="footer">
                          <p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC. All rights reserved.<br><span style="font-size: 12px;">ClaimYourVoice is a brand and online service operated by ClaimYourVoice LLC.</span></p>
                        </div>
        ...
        if (resendData) {
          ...
          await resendData.client.emails.send({
            ...
            html: `
              ...
              <blockquote style="border-left: 3px solid #0D566C;padding-left:12px;margin:12px 0;">${message}</blockquote>
              <p><a href="https://www.claimyourvoice.org/dashboard/${senderRole === 'mentor' ? 'entrepreneur' : 'mentor'}" style="background-color: #FF6B5C;color:white;padding:10px 20px;text-decoration:none;border-radius:25px;display:inline-block;">View in Dashboard</a></p>
              <p>Best,<br>ClaimYourVoice Team</p>
                        </div>
                        <div class="footer">
                          <p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC. All rights reserved.<br><span style="font-size: 12px;">ClaimYourVoice is a brand and online service operated by ClaimYourVoice LLC.</span></p>
            ...
            html: `
                    ...
                    <body style="background-color: #FAF9F7;">
                      <div class="container">
                        ...
                        <div class="content">
                          <p><strong>${entrepreneurName || 'An entrepreneur'}</strong> would like to connect with you on ClaimYourVoice.</p>
        ...
        if (resendData) {
          ...
          try {
            await resendClient.emails.send({
              from: fromEmail,
              to: email,
              subject: "ClaimYourVoice - Login Reminder",
              html: `
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body style="background-color: #FAF9F7;">
                  <div class="container">
                    ...
                    <div class="content">
                      <p>This is a reminder that you already have an account with ClaimYourVoice.</p>
        ...
        if (coachData?.email) {
          ...
          if (resendConfig) {
            ...
            await resendConfig.client.emails.send({
              from: resendConfig.fromEmail,
              to: coachData.email,
              subject: `New ${rating}-Star Review on ClaimYourVoice`,
              html: `
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body style="background-color: #FAF9F7;">
                  <div class="container">
                    ...
                    <div class="content">
                      ...
                      <p>Great news! An entrepreneur has left you a review on ClaimYourVoice.</p>
                      ...
                      <p style="text-align: center;"><a href="https://claimyourvoice.org/login" class="button">View Your Dashboard</a></p>
                      <p>Best regards,<br>The ClaimYourVoice Team</p>
                    </div>
                    <div class="footer">
                      <p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC. All rights reserved.<br><span style="font-size: 12px;">ClaimYourVoice is a brand and online service operated by ClaimYourVoice LLC.</span></p>
        ...
        try {
          if (fromAdmin && existingData.email) {
            ...
            await resendData.client.emails.send({
              ...
              subject: "Response from The Founder Guidance Team - ClaimYourVoice",
              html: `
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body style="background-color: #FAF9F7;">
                  <div class="container">
                    ...
                    <div class="content">
                      ...
                      <p>Best regards,<br><strong>The ClaimYourVoice Team</strong></p>
                    </div>
                  </div>
                </body>
                </html>
      ...
      if (resendData && existingData.email) {
        try {
          await resendData.client.emails.send({
            from: resendData.fromEmail,
            to: existingData.email,
            subject: "New Note from ClaimYourVoice Admin",
            html: `
              <!DOCTYPE html>
              <html>
              <head>
              ...
              <body style="background-color: #FAF9F7;">
                <div class="container">
                  ...
                  <div class="content">
                    <p>Hi ${existingData.full_name || "there"},</p>
                    <p>You have received a new note from The Founder Guidance Team at ClaimYourVoice:</p>
                    <div class="note-box">
  ...
  // Early Access Signup - sends notification to hello@claimyourvoice.org
      ...
      if (resendData) {
        ...
        try {
          ...
          await resend.emails.send({
            from: fromEmail,
            to: email,
            subject: "You're on the ClaimYourVoice Early Access List!",
            html: `
              <!DOCTYPE html>
              <html>
              <head>
              ...
              <body style="background-color: #FAF9F7;">
                <div class="container">
                  ...
                  <div class="content">
                    <p>Thank you for joining the ClaimYourVoice early access list!</p>
                    ...
                    <p>In the meantime, here's what ClaimYourVoice will help you do:</p>
                    <ul>
          ...
          await resend.emails.send({
            from: fromEmail,
            to: "hello@claimyourvoice.org",
            subject: "New Early Access Signup - ClaimYourVoice",
            html: `
              <!DOCTYPE html>
              <html>
              <head>
              ...
              <body style="background-color: #FAF9F7;">
                <div class="container">
                  ...
                  <div class="content">
                    <p>Someone just signed up for early access to ClaimYourVoice.</p>
                  ...
                  <div class="footer">
                    <p>&copy; ${new Date().getFullYear()} ClaimYourVoice</p>
                  </div>
                </div>
              </body>
              </html>
          ...
          console.log("[EARLY ACCESS] Admin notification sent to hello@claimyourvoice.org");
        } catch (emailError: any) {
      ...
      if (resendData) {
        ...
        try {
          await resend.emails.send({
            from: fromEmail,
            to: email,
            subject: "You're on the ClaimYourVoice Mentor Waiting List",
            html: `
              <!DOCTYPE html>
              <html>
              <head>
              ...
              <body style="background-color: #FAF9F7;">
                <div class="container">
                  ...
                  <div class="content">
                    <p>We're honored by your interest in becoming a mentor at ClaimYourVoice.</p>
    ...
    try {
      ...
      for (const entrepreneur of entrepreneurs) {
        ...
        await (client.from("messages").insert({
          ...
          from_email: mentorEmail || "system@claimyourvoice.org",
  ...
  app.post("/api/admin/send-meeting-invite", async (req, res) => {
    try {
              ...
              <body style="background-color: #FAF9F7;">
                <div class="container">
                  ...
                  <div class="content">
                    ...
                    <p>${hostName || "ClaimYourVoice Admin"} has scheduled a meeting with you.</p>
      ...
      await (client.from("messages").insert({
        from_name: hostName || "ClaimYourVoice Admin",
        from_email: "admin@claimyourvoice.org",
        ...
        try {
          ...
          if (investor) {
            ...
            const newMeeting = {
              ...
              joinUrl,
              password,
              hostName: hostName || "ClaimYourVoice Admin",
              createdAt: new Date().toISOString(),
              status: "scheduled"
            };
    ...
    try {
      ...
      const { data: savedMeeting, error: dbError } = await (client
        ...
        .insert({
          ...
          join_url: joinUrl,
          password,
          host_name: hostName || "ClaimYourVoice Admin",
    ...
    try {
      ...
      try {
        await (client
          ...
          .insert({
            from_name: "System",
            from_email: "system@claimyourvoice.org",
            to_name: "Admin",
            to_email: "admin@claimyourvoice.org",
  ...
  app.post("/api/cancellation-request", async (req, res) => {
    ...
    try {
      ...
      console.log("[CANCELLATION] Sending admin email from:", fromEmail, "to: hello@claimyourvoice.org");
      ...
      const userSubject = "Your Cancellation Request Has Been Received - ClaimYourVoice";
        ...
        <body style="background-color: #FAF9F7;">
          <div class="container">
            ...
            <div class="content">
              ...
              <p>We have received your request to cancel your ${userType} account with ClaimYourVoice.</p>
              ...
              <p>Our team will review your request and process it within 2-3 business days. If you have any questions or would like to reconsider, please don't hesitate to reach out to us at <a href="mailto:hello@claimyourvoice.org">hello@claimyourvoice.org</a>.</p>
            ...
            <div class="footer">
              <p>© 2026 ClaimYourVoice LLC. All rights reserved.</p>
            </div>
          </div>
        </body>
        </html>
  ...
  // Check if entrepreneur has accepted latest agreement
  ...
  app.post("/api/contract-acceptances/accept-coach-agreement", async (req, res) => {
    ...
    try {
      ...
      const contractText = `ClaimYourVoice Coach Agreement (${CURRENT_COACH_AGREEMENT_VERSION})

By accepting this agreement, the coach acknowledges and agrees to:
- Provide professional coaching services to entrepreneurs on the ClaimYourVoice platform
- Maintain confidentiality of all client information
- Accept that ClaimYourVoice retains a 20% platform fee on all coaching transactions
...
- ClaimYourVoice reserves the right to terminate partnerships for violations of these terms

Full terms available at: https://claimyourvoice.org/coach-agreement`;
                ...
                if (resendData) {
                  ...
                  try {
                    await resendClient.emails.send({
                      from: fromEmail,
                      to: membershipEmail,
                      subject: "Payment Received - ClaimYourVoice Membership",
                      html: `
                    <!DOCTYPE html>
                    <html>
                    <head>
                  ...
                  await resendClient.emails.send({
                    ...
                    <body style="background-color: #FAF9F7;">
                      <div class="container">
                        ...
                        <p>Best,<br>The ClaimYourVoice Team</p>
                        </div>
                        <div class="footer">
                          <p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC. All rights reserved.<br><span style="font-size: 12px;">ClaimYourVoice is a brand and online service operated by ClaimYourVoice LLC.</span></p>
                        </div>
...
`;
  ...
  app.post("/api/community/auto-signup", async (req, res) => {
    try {
      ...
      const frontendBase = process.env.FRONTEND_URL || (process.env.NODE_ENV === "development" ? "http://localhost:5000" : "https://claimyourvoice.org");
      ...
      try {
        ...
        if (resendData) {
          ...
          await resendClient.emails.send({
            from: fromEmail,
            to: normalizedEmail,
            subject: "Your ClaimYourVoice Dashboard Is Ready — Set Your Password",
            html: `
              <!DOCTYPE html>
              <html>
              <head>
              ...
              <body style="background-color: #FAF9F7;">
                <div class="container">
                  <div class="header">
                    <h1>Welcome to ClaimYourVoice!</h1>
                  </div>
                  <div class="content">
                    <p>Hi ${name},</p>
                ...
                <body style="background-color: #FAF9F7;">
                  <div class="container">
                    ...
                    <div class="content">
                      ...
                      <p><a href="https://claimyourvoice.org/admin-dashboard" style="display: inline-block; background-color: #FF6B5C; color: white; padding: 12px 24px; border-radius: 25px; text-decoration: none; font-weight: bold;">View in Admin Dashboard</a></p>
                    </div>
                    <div class="footer">
                      <p>&copy; ${new Date().getFullYear()} ClaimYourVoice LLC. All rights reserved.</p>
                    </div>
                  </div>
                </body>
                </html>
      ...
      try {
        ...
        if (resendData) {
          ...
          await resendClient.emails.send({
            from: fromEmail,
            to: normalizedEmail,
            subject: "Welcome to ClaimYourVoice Community!",
            html: `
                    <!DOCTYPE html>
                    <html>
                    <head>
    ...
    try {
      ...
      if (resend) {
        ...
        await resend.client.emails.send({
          ...
          to: normalizedEmail,
          subject: "Welcome to ClaimYourVoice - Your 7-Day Trial",
          html: `
                    <!DOCTYPE html>
                    <html>
                    <head>
    ...
    try {
      ...
      if (resend) {
        ...
        await resend.client.emails.send({
          from: resend.fromEmail,
          to: normalizedEmail,
          subject: "ClaimYourVoice - Set Up Your Password (New Link)",
          html: `
                    <!DOCTYPE html>
                    <html>
                    <head>
